;(function (){
    ...
    TreatmentCtrl.$inject = ['$scope', '$state','ModalService', 'QueryService','logger','$uibModalStack','$location','$filter','$stateParams'];

    function TreatmentCtrl($scope, $state, ModalService, QueryService,logger, $uibModalStack,$location,$filter, $stateParams) {
        var vm = this;

        
        vm.titleHeader = 'Treatment';
