;(function (){
    ...
    angular
        .module('app')
        .controller('NewCustomerProfileCtrl', NewCustomerProfileCtrl);

    NewCustomerProfileCtrl.$inject = ['$scope', '$state','ModalService', 'QueryService','logger','$uibModalStack','$location','$filter','$stateParams'];

    function NewCustomerProfileCtrl($scope, $state, ModalService, QueryService,logger, $uibModalStack,$location,$filter, $stateParams) {
        var vm = this;

        
        vm.titleHeader = 'New Customer';
