;(function (){
    ...
    angular
        .module('app')
        .controller('NewMedicalHistoryCtrl', NewMedicalHistoryCtrl);

    NewMedicalHistoryCtrl.$inject = ['$scope', '$state','ModalService', 'QueryService','logger','$uibModalStack','$location','$filter','$stateParams'];

    function NewMedicalHistoryCtrl($scope, $state, ModalService, QueryService,logger, $uibModalStack,$location,$filter, $stateParams) {
        var vm = this;

        
        vm.titleHeader = 'Medical History';
